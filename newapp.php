<?php
    ...
    if(isset($_POST['bookappt'])){
        ...
        $sql1 = $konek->query("INSERT INTO patients (`appointment_date`, `time`, `first_name`, `last_name`, `birthdate`, `contact_num`, `purpose`, `id`) VALUES ('$appointment_date','$time', '$first_name', '$last_name', '$birthdate', '$contact_num', '$purpose', '$userId')");
